...
class PageTool {
     ...
     */
    public static function show($url,$count,$page,$pageSize,$params=array()){  //$_REQEST
        ...
        /**
         * 第一种情况:
         * $url = "index.php?name=value&name=value";
         * 第二种情况:
         * $url = "index.php?p=Admin&c=Goods&name=value&name=value&page";
         *
         * 第二种情况:
         * $url = "index.php?p=Admin&c=Goods&page";
         */

        $url.=parse_url($url,PHP_URL_QUERY)?'&':'?';
        //将数组   $params = array('usrname'=>'zhangsan','age'=>28);  变成    name=value&name=value
        unset($params['page']);  //删除不让其参数url地址的拼装
